...
int main(int argc, char** argv) 
{
    ...
    TH1F* h_mu       = new TH1F("mu-", "mu-", 100, 0, 20);
    TH1F* h_mu_plus  = new TH1F("mu+", "mu+", 100, 0, 20);
    TH1F* h_pi       = new TH1F("pi", "pi", 100, 0, 20);
    TH1F* h_K        = new TH1F("K", "K", 100, 0, 20);
    TH1F* h_e        = new TH1F("e", "e", 100, 0, 20);
    TH1F* h_n        = new TH1F("n", "n", 100, 0, 20);
    TH1F* h_p        = new TH1F("p", "p", 100, 0, 20);
    TH1F* h_other    = new TH1F("other", "other", 100, 0, 20);
